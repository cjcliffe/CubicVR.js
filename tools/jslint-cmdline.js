...
// www.JSLint.com
// Rhino Edition
// Changes for SpiderMonkey by David Humphrey
"use strict";
var JSLINT = (function () {
    var adsafe_id, adsafe_may, adsafe_went, anonname, approved, atrule = {
        ...
        funct, functionicity = ['closure', 'exception', 'global', 'label', 'outer', 'unused', 'var'],
        functions, global, htmltag = {
        a: {},
        abbr: {},
        acronym: {},
        address: {},
        ...
        ids, implied, inblock, indent, jsonmode, lines, lookahead, member, membersOnly, nexttoken, noreach, option, predefined, prereg, prevtoken, rhino = {
        defineClass: false,
        deserialize: false,
        gc: false,
        help: false,
        ...
        strict_mode, syntax = {},
        tab, token, urls, warnings, widget = {
        alert: true,
        animator: true,
        appleScript: true,
        beep: true,
        ...
        xmode, xquote, ax = /@cc|<\/?|script|\]*s\]|<\s*!|&lt/i,
        cx = /[\u0000-\u001f\u007f-\u009f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/,
    ...
    cssBreak = ['auto', 'always', 'avoid', 'left', 'right'];
